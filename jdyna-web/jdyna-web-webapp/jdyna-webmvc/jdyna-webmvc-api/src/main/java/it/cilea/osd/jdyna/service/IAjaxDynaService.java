...
public interface IAjaxDynaService {
	...
	public <T extends Selectable> List<String> searchCollisioni(String field, String classCollisione,String inputValue,String rootPath) throws IOException, ClassNotFoundException;
